    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="editSupplierModalLabel" style="color: black; text-align:center">Edit Supplier</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form wire:submit.prevent="editSupplier" action="">
                ...
                <div class="row">
                    ...
                    <div class="row" style="margin-top:10px">
                        ...
                        <div class="col" style="display: flex;">
                            ...
                            <div class="col">
                                <input style="margin-left: 50px" wire:model="isactive" class="form-check-input" type="checkbox" name="IsActive">
                            </div>
                        </div>
            ...
            <div class="row" style="padding: 20px;text-align:center">
                ...
                <div wire:ignore class="col">
                    <select id="category-select-edit" class="form-select" style="display: inline;width: 30%;margin-right:5px">
                    ...
                    <select id="subcategory-select-edit" class="form-select" style="display: inline;width: 30%;margin-right:5px">
